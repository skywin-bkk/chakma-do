...
ROOT=Path('website')
MASTER={
'index.html','community.html','identity.html','history.html','villages.html','community-data.html','culture-heritage.html','gallery.html','language.html','people.html','directory.html','professionals.html','programs.html','education.html','youth.html','women-family.html','livelihoods.html','wellbeing.html','knowledge.html','opportunity-center.html','opportunities.html','services.html','library.html','community-life.html','updates.html','get-involved.html','about.html','strategy.html','governance.html','departments.html','policies.html','contact.html','community-hub.html'
}
ALIASES={'participate.html':'get-involved.html'}
class P(HTMLParser):
...
for alias,canonical in ALIASES.items():
 if alias not in parsed: errors.append(f'Missing compatibility alias: {alias}')
 if canonical not in parsed: errors.append(f'Missing canonical page for alias {alias}: {canonical}')
for path in htmls:
...
print('Compatibility aliases: SAFE; internal canonical-route lock ACTIVE')
